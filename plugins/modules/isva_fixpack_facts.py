...
from ansible_collections.community.isva.plugins.module_utils.isva_fixpacks import fetch_fixpacks
...
def exec_module(module):
    ...
    ansible_facts = {'isva_fixpacks': response}
