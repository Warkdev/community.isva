...
EXAMPLES = r'''
- name: Collect ISVA extensions status
  isva_extension_facts:
'''
...
from ansible_collections.community.isva.plugins.module_utils.isva_extensions import fetch_extensions
...
def __exec_get_facts(module):
    response = fetch_extensions(module=module)
    return response
